...
import com.hmz.agressores_da_bola.infrastructure.security.JwtConfig;
import com.hmz.agressores_da_bola.web.security.SecurityConfig;
 ...
 */
@WebMvcTest({PeladaController.class, EscalacaoController.class})
...
class PeladaControllerWebMvcTest {
    ...
    void escritaSemToken() throws Exception {
        ...
        verifyNoInteractions(peladaService, escalacaoService);
    }
