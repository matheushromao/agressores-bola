...
import com.hmz.agressores_da_bola.application.usuario.UsuarioService;
...
import com.hmz.agressores_da_bola.web.dto.UsuarioRequest;
...
public class UsuarioController {
    ...
    public ResponseEntity<PageResponse<UsuarioResponse>> listar(
        ...
        return ResponseEntity.ok(usuarioService.listar(new UsuarioFiltro(posicao, busca, nacionalidade), pageable));
    }
    ...
    public ResponseEntity<UsuarioResponse> atualizar(@PathVariable Long id,
        ...
        return ResponseEntity.ok(usuarioService.atualizar(id, request.paraPerfil(), UsuarioLogado.id(jwt)));
    }
