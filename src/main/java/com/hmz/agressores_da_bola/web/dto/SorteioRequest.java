...
import com.hmz.agressores_da_bola.application.sorteio.CriterioSorteio;
...
public record SorteioRequest(
    ...
    public CriterioSorteio paraCriterio() {
        return new CriterioSorteio(quantidadeTimes, jogadoresPorTime, semente);
    }
