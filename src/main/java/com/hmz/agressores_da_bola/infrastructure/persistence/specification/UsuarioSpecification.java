...
public final class UsuarioSpecification {
    ...
    public static Specification<Usuario> de(UsuarioFiltro filtro) {
        return Specification.allOf(
                comPosicao(filtro.posicao()),
                comNomeOuNickname(filtro.busca()),
                daNacionalidade(filtro.nacionalidade())
        );
    }
