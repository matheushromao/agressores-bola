 ...
 * {@link Random}, devolve os times, e por isso pode ser testada sozinha. O
 * bean é registrado na configuração da infraestrutura.</p>
 */
public class BalanceadorDeTimes {
    ...
    private int indiceDoTimeMaisFraco(List<List<JogadorSorteavel>> times, int jogadoresPorTime) {
        ...
        // Só acontece se não houver vaga alguma, o que a DivisaoDeTimes já impede.
